...
from app.data.feed_manager import get_feed_manager
from app.data.store import get_store
from app.markets.ashare.akshare_feed import akshare_feed
from app.markets.ashare.tdx_realtime import get_tdx_engine, MARKET_SH, MARKET_SZ
...
async def get_capital_flow(
    ...
    """个股资金流向 (adata)"""
    from app.data.http_feed import AdataFeed
    feed = AdataFeed()
